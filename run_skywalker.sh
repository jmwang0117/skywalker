...
gnome-terminal --window -e 'bash -c "source ~/skywalker/devel/setup.bash; roslaunch turn_on_wheeltec_robot turn_on_wheeltec_robot.launch "' \
--tab -e 'bash -c "sleep 10; source ~/skywalker/devel/setup.bash; roslaunch wheeltec_robot_rc keyboard_teleop.launch; exec bash"' \
